...
const routes = [
  ...
  { path: '/library', name: 'library', component: () => import('./views/SubtitleAtlas.vue'), meta: { title: '内容库(AI)', icon: '🎬', hidden: true } },
  { path: '/blue-ocean', name: 'blue-ocean', component: () => import('./views/BlueOcean.vue'), meta: { title: '蓝海雷达', icon: '🌊', hidden: true } },
