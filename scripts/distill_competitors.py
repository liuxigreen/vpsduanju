...
def extract_content_tags(titles, description_tags=None):
    ...
    keywords = {
        ...
        '爱情': '爱情', '宫廷': '宫廷', '玄幻': '玄幻',
        # 韩语 (계약결혼=契约婚姻 재벌=豪门 불륜=背叛 이혼=离婚 복수=复仇 임신=怀孕 아기=萌宝 비밀=秘密身份)
        '계약': '契约婚姻', '결혼': '契约婚姻', '재벌': '豪门', '불륜': '背叛',
        '이혼': '离婚', '복수': '复仇', '임신': '怀孕', '아기': '萌宝',
        '비밀': '秘密身份', '복종': '霸总', '회장': '霸总',
        # 日语 (許婚=婚约 大富豪=豪门 復讐=復仇 契約結婚=契约婚姻 秘密=秘密身份 妊娠=怀孕 裏切り=背叛 離婚=离婚)
        '許婚': '契约婚姻', '大富豪': '豪门', '復讐': '复仇', '契約結婚': '契约婚姻',
        '秘密': '秘密身份', '妊娠': '怀孕', '裏切り': '背叛', '離婚': '离婚',
        '社長': '霸总', '取締役': '霸总',
        # 土耳其语 (zengin=豪门 aşk=爱情 intikam=复仇 hamile=怀孕 gizli=秘密身份 boşanma=离婚 bebek=萌宝)
        'zengin': '豪门', 'aşk': '爱情', 'intikam': '复仇', 'hamile': '怀孕',
        'gizli': '秘密身份', 'boşanma': '离婚', 'bebek': '萌宝', 'yalan': '假身份',
    }
